...
const (
	RecommendationService_GetRecommendations_FullMethodName = "/recommendationService.RecommendationService/GetRecommendations"
)
...
func (c *recommendationServiceClient) GetRecommendations(ctx context.Context, in *RecommendationsRequest, opts ...grpc.CallOption) (*RecommendationsResponse, error) {
...
func (UnimplementedRecommendationServiceServer) GetRecommendations(context.Context, *RecommendationsRequest) (*RecommendationsResponse, error) {
...
func _RecommendationService_GetRecommendations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RecommendationServiceServer).GetRecommendations(ctx, req.(*RecommendationsRequest))
	}
